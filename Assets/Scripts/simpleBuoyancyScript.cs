...
public class simpleBuoyancyScript : MonoBehaviour
{
    ...
    [SerializeField]
    private float buoyancyReduction = 20f;
    [SerializeField]
    private float dampingReduction= 150f;
    ...
    private void OnTriggerStay(Collider other)
    {
        try
        {
            ...
            Debug.Log(rb.gameObject.name + (this.gameObject.transform.position.y - rb.transform.TransformPoint(rb.centerOfMass).y));
